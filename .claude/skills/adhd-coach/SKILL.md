...
This skill coaches the user through ongoing self-management at the intersection of ADHD and addiction. It operationalizes the frameworks from the "ADHD and Addiction with Mike and Amber" podcast series and Dr. Anna Lembke's dopamine work, both archived in `vault/podcasts/`. It reads and writes the workspace at `vault/adhd/`.
